Criar a classe Funcionario (id, nome) e Endereco (rua, cidade, estado, cep) e a relação entre as duas classes. Criar a interface FuncionarioRepository herdando de JpaRepository.
